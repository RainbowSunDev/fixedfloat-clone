...
import { OrderDetailsRequest, QrCodesResponse } from '@/types';
...
const getOrderDetails = async (params: OrderDetailsRequest) : Promise<QrCodesResponse> => {
    const url = `https://ff.io/api/v2/qr`;
